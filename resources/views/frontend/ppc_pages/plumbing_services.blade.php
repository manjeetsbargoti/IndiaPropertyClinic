                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-6 col-xl-6">
                            ...
                            <a href="tel:{{ config('app.phone') }}" role="button" class="btn btn-lg btn-info"><span class="spinner-grow spinner-grow-sm"></span> Call Now</a>
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-xl-6">
                            <div class="ser_prcessing">
                                <!-- MultiStep Form -->
                                <form id="PPCLeadForm" name="ppc_lead_form" method="post"
                                    action="{{ url('/ipc/plumbing-services') }}">
                                    ...
                                    <div class="row">
                                        <div id="SubServiceOn" class="form-group col-12 col-sm-6">
                                            ...
                                            <select name="sub_service" id="SubServiceOnList" class="form-control">
                                                ...
                                                @foreach(\App\OtherServices::where('parent_id', 6)->get() as $oths)
