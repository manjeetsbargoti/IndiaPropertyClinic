...
<div class="smart_container">
    <div class="loanbanner" style="{{ asset('/images/frontend_images/images/loanbg-01.svg') }}">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-lg-4 col-xl-4">
                    <div class="loanbann_right">
                        <img height="250" src="{{ asset('/images/frontend_images/images/loanbanner-01.svg') }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="formboxed mb-0">
                    ...
                    <form name="home_loan_form" id="home_loan_form" method="post" action="{{ url('/Apply-Home-Loan') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group apply_strip">
                                        <label class="checkbox_container"> By submitting this form you are accepting IndiaPropertyClinic.com <a href="{{ url('/') }}">Terms & Conditions</a>
