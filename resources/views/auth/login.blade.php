                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin" name="userLoginForm" id="userLoginForm" method="post" action="{{ url('/login') }}">
                            ...
                            <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">Sign
                                in</button>
                            <span class="d-block mt-2">New User? <a href="{{ url('/register') }}">Register</a></span>
                            <span class="d-block">Problem in Sign in? <a href="{{ url('/password/verify/email') }}">Forgot Password</a></span>
                            <hr class="my-4">
