...
<head>
    ...
    <!-- for Google -->
    <meta name="title" content="@if(!empty($meta_title)){{ $meta_title }}@endif" />
    <meta name="description" content="@if(!empty($meta_description)){{ $meta_description }}@endif" />
    <meta name="keywords" content="@if(!empty($meta_keywords)){{ $meta_keywords }}@endif" />
    <link rel="canonical" href="@if(!empty($canonical_url)){{ $canonical_url }}@endif" />
    <meta name="copyright" content="Copyright (C) Since 2019 - This Content is owned by {{config('app.name')}}" />

    <!-- for Facebook -->
    <meta property="og:title" content="@if(!empty($meta_title)){{ $meta_title }}@endif" />
    <meta property="og:type" content="article" />
    <meta property="og:description" content="@if(!empty($meta_description)){{ $meta_description }}@endif" />
    <meta property="og:image" content="@if(!empty($page_image)){{ $page_image }}@endif" />
    <meta property="og:url" content="@if(!empty($canonical_url)){{ $canonical_url }}@endif" />

    <!-- for Twitter -->
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="@if(!empty($meta_title)){{ $meta_title }}@endif" />
    <meta name="twitter:description" content="@if(!empty($meta_description)){{ $meta_description }}@endif" />
    <meta name="twitter:image" content="@if(!empty($page_image)){{ $page_image }}@endif" />
    ...
    <title>@if(!empty($meta_title)){{ $meta_title }}@endif</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/frontend_css/style2.css') }}">
