  ...
  <aside class="main-sidebar">
      ...
      <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
              ...
              <li class="{{ (request()->is('admin/dashboard')) ? 'active':'' }}"><a href="{{ url('/admin/dashboard') }}"><i class="fa fa-dashboard"></i>
            ...
            @if(Auth::user()->admin  == 1)
              <li class="treeview {{ (request()->is('admin/system*')) ? 'active':'' }}">
                  ...
                  <ul class="treeview-menu">
                      ...
                      <li class="{{ (request()->is('admin/system/options')) ? 'active':'' }}"><a href="{{ url('/admin/system/options') }}"><i class="fa fa-sliders text-yellow"></i>Site
                              Options</a></li>
                      <li class="{{ (request()->is('admin/system/contact-info')) ? 'active':'' }}"><a href="{{ url('/admin/system/contact-info') }}"><i class="fa fa-phone text-yellow"></i>Contact
                              Info</a></li>
                      <li class="{{ (request()->is('admin/system/robots.txt')) ? 'active':'' }}"><a href="{{ url('/admin/system/robots.txt') }}"><i class="fa fa-file text-yellow"></i>Robots.txt</a>
                      </li>
                      <li class="{{ (request()->is('admin/system/htaccess')) ? 'active':'' }}"><a href="{{ url('/admin/system/htaccess') }}"><i class="fa fa-file text-yellow"></i>.htaccess</a>
                      </li>
                      <li class="{{ (request()->is('admin/system/custom-code')) ? 'active':'' }}"><a href="{{ url('/admin/system/custom-code') }}"><i class="fa fa-code text-yellow"></i>Custom
                              Code</a></li>
                      <li class="{{ (request()->is('admin/system/editor')) ? 'active':'' }}"><a href="{{ url('/admin/system/editor') }}"><i class="fa fa-terminal text-yellow"></i>Editor</a></li>
                  </ul>
              </li>
            @endif
            @if(Auth::user()->admin  == 1)
              <li class="treeview {{ (request()->is('admin/contacts*')) ? 'active':'' }}">
                  ...
                  <ul class="treeview-menu">
                      <li class="{{ (request()->is('admin/contacts')) ? 'active':'' }}"><a href="{{ url('/admin/contacts') }}"><i class="fa fa-building text-green"></i> <span>Contact
                                  List</span></a></li>
                      <li class="{{ (request()->is('admin/contacts/new')) ? 'active':'' }}"><a href="{{ url('/admin/contacts/new') }}"><i class="fa fa-building text-green"></i> <span>Add
                                  Contact</span></a></li>
                  </ul>
              </li>
            @endif
            @if(Auth::user()->admin  == 1 || Auth::user()->usertype  == 'S')
              <li class="treeview {{ (request()->is('admin/pages*')) ? 'active':'' }}">
                  ...
                  <ul class="treeview-menu">
                      <li class="{{ (request()->is('admin/pages')) ? 'active':'' }}"><a href="{{ url('/admin/pages') }}"><i class="fa fa-file text-green"></i> <span>Pages</span></a></li>
                      <li class="{{ (request()->is('admin/pages/new')) ? 'active':'' }}"><a href="{{ url('/admin/pages/new') }}"><i class="fa fa-plus text-green"></i> <span>Add
                                  Page</span></a></li>
                  </ul>
              </li>
            @endif
            @if(Auth::user()->admin == 1)
              <li class="treeview {{ (request()->is('admin/ppc*')) ? 'active':'' }}">
                  <a href="{{ url('/admin/ppc/pages') }}"><i class="fa fa-telegram text-green"></i> <span>PPC Management</span>
                      <span class="pull-right-container">
                          <i class="fa fa-angle-left pull-right"></i>
                      </span>
                  </a>
            ...
            @if(Auth::user()->admin  == 1)
              <li class="treeview {{ (request()->is('admin/user*')) ? 'active':'' }}">
                  ...
                  <ul class="treeview-menu">
                      <li class="{{ (request()->is('admin/users')) ? 'active':'' }}"><a href="{{ url('/admin/users') }}"><i class="fa fa-circle-o text-yellow"></i>All Users</a>
                      </li>
                      <li class="{{ (request()->is('admin/user/new')) ? 'active':'' }}"><a href="{{ url('/admin/user/new') }}"><i class="fa fa-user-plus text-yellow"></i>Add
                              User</a></li>
              ...
              <li class="treeview {{ (request()->is('admin/service*')) ? 'active':'' }}">
                  ...
                  <ul class="treeview-menu">
                      <li class="{{ (request()->is('admin/services')) ? 'active':'' }}"><a href="{{ url('/admin/services') }}"><i class="fa fa-circle-o text-red"></i>View
                              Services</a></li>
                      <li class="{{ (request()->is('admin/service/new')) ? 'active':'' }}"><a href="{{ url('/admin/service/new') }}"><i class="fa fa-circle-o text-red"></i>Add Services</a></li>
                  </ul>
              </li>
            @endif
            @if(Auth::user()->admin  == 1)
            ...
            @if(Auth::user()->usertype  == 'A' || Auth::user()->usertype  == 'B' || Auth::user()->usertype  == 'U' || Auth::user()->usertype  == 'S' || Auth::user()->admin == 1)
              ...
              @endif
              @if(Auth::user()->usertype  == 'A' || Auth::user()->usertype  == 'B' || Auth::user()->usertype  == 'U' || Auth::user()->usertype  == 'S' || Auth::user()->admin == 1)
              <li class="treeview {{ (request()->is('admin/categories*')) ? 'active':'' }} {{ (request()->is('admin/blog*')) ? 'active':'' }}">
                  <a href="{{ url('/admin/blog') }}"><i class="fa fa-building text-green"></i> <span>Blog</span>
                      <span class="pull-right-container">
                          <i class="fa fa-angle-left pull-right"></i>
                      </span>
                  </a>
                  <ul class="treeview-menu">
                      <li class="{{ (request()->is('admin/blog*')) ? 'active':'' }}"><a href="{{ url('/admin/blog') }}"><i class="fa fa-circle-o text-purple"></i>All Blog</a></li>
                      <li class="{{ (request()->is('admin/categories*')) ? 'active':'' }}"><a href="{{ route('admin.categories') }}"><i class="fa fa-circle-o text-purple"></i>All categories</a></li>
                  </ul>
              </li>
              @endif
              @if(Auth::user()->admin  == 1)
