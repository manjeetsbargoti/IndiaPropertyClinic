      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('/admin/options') }}"><i class="fa fa-sliders text-yellow"></i>Site Options</a></li>
            <li><a href="{{ url('/admin/robots.txt') }}"><i class="fa fa-file text-yellow"></i>Robots.txt</a></li>
            <li><a href="{{ url('/admin/htaccess') }}"><i class="fa fa-file text-yellow"></i>.htaccess</a></li>
            <li><a href="{{ url('/admin/custom-code') }}"><i class="fa fa-code text-yellow"></i>Custom Code</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ url('/admin/add-new-user') }}"><i class="fa fa-user-plus text-yellow"></i>Add User</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url('/admin/sitemap') }}"><i class="fa fa-map text-yellow"></i> <span>Sitemap</span></a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
