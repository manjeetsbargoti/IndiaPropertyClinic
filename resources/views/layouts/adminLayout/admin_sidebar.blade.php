      ...
      <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
              ...
              <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                        <li><a href="{{ url('/admin/contacts') }}"><i class="fa fa-building text-green"></i> <span>Contact List</span></a></li>
                        <li><a href="{{ url('/admin/new-contact') }}"><i class="fa fa-building text-green"></i> <span>Add Contact</span></a></li>
                  </ul>
              </li>
              <li class="treeview">
              ...
              <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                      <li><a href="{{ url('/admin/add-city') }}"><i class="fa fa-building text-green"></i> <span>Add
                                  City</span></a></li>
                      <li><a href="{{ url('/admin/add-state') }}"><i class="fa fa-building text-green"></i> <span>Add
                                  State</span></a></li>
                  </ul>
              </li>
              <li class="treeview">
