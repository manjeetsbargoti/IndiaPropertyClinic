                                    ...
                                    <div class="property_basic col-sm-12 col-md-12">
                                        ...
                                        <div class="col-xs-12 col-md-4 hidden">
                                            ...
                                            <label name="Property Code">Property Code</label>
                                                <div class="input-group"> 
                                                    <input name="property_code" id="property_code" type="text" value="{{ $properties->property_code }}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="property_price" id="property_price" type="text" class="form-control" value="{{ $properties->property_price }}">
                                            </div>
                                        </div>
                                        ...
                                        <div id="MapPassed" class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="map_passed" id="map_passed" class="form-control">
                                                    <option @if($properties->map_pass == '') selected @endif value="">Select</option>
                                                    <option @if($properties->map_pass == '1') selected @endif  value="1">Yes</option>
                                                    <option @if($properties->map_pass == '0') selected @endif value="0">No</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="OpenSides" class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="open_sides" id="open_sides" class="form-control">
                                                    <option value="" @if($properties->open_sides == '') selected @endif>Select Open Sides</option>
                                                    <option @if($properties->open_sides == '1') selected @endif value="1">1</option>
                                                    <option @if($properties->open_sides == '2') selected @endif value="2">2</option>
                                                    <option @if($properties->open_sides == '3') selected @endif value="3">3</option>
                                                    <option @if($properties->open_sides == '4') selected @endif value="4">4</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="property_area" id="property_area" value="{{ $properties->parea }}" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="WidthRoadFacing" class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="width_road_facing" id="width_road_facing" type="text" value="{{ $properties->widthroad }}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="FurnishStatus" class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="furnish_type" id="furnish_type" class="form-control">
                                                    <option value="" @if($properties->furnish_type == '') selected @endif>Select Furnish Type</option>
                                                    <option value="F" @if($properties->furnish_type == 'F') selected @endif>Fully Furnished</option>
                                                    <option value="S" @if($properties->furnish_type == 'S') selected @endif>Semi Furnished</option>
                                                    <option value="U" @if($properties->furnish_type == 'U') selected @endif>Unfurnished</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="transection_type" id="transection_type" class="form-control">
                                                    <option value="" @if($properties->transaction_type == '') selected @endif>Select Transaction Type</option>
                                                    <option value="New Booking" @if($properties->transaction_type == 'New Booking') selected @endif>New Booking</option>
                                                    <option value="Resale" @if($properties->transaction_type == 'Resale') selected @endif>Resale</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="construction_status" id="construction_status" class="form-control">
                                                    <option value="" @if($properties->construction_status == '') selected @endif>Select Construction Status</option>
                                                    <option value="UC" @if($properties->construction_status == 'UC') selected @endif>Under Construction</option>
                                                    <option value="RM" @if($properties->construction_status == 'RM') selected @endif>Ready to Move</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="FloorNo" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="floor_no" id="floor_no" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<165; $i++) { ?>
                                                        <option @if($properties->floorno == $i) selected @endif value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="TotalFloor" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="total_floors" id="total_floors" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<165; $i++) { ?>
                                                        <option @if($properties->total_floors == $i) selected @endif value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="trees" id="trees" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<1001; $i++) { ?>
                                                        <option @if($properties->apple_trees == $i) selected @endif value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="Bedrooms" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="bedrooms" id="bedrooms" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<250; $i++) { ?>
                                                        <option @if($properties->bedrooms == $i) selected @endif value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="Bathrooms" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="bathrooms" id="bathrooms" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<150; $i++) { ?>
                                                        <option @if($properties->bathrooms == $i) selected @endif value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="Balconies" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="balconies" id="balconies" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<165; $i++) { ?>
                                                        <option @if($properties->balconies == $i) selected @endif value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="property_age" id="property_age" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<100; $i++) { ?>
                                                        <option @if($properties->property_age == $i) selected @endif value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="property_address col-sm-12 col-md-12">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="property_address1" id="property_address1" class="form-control" rows="3" placeholder="Address Line 1">{{ $properties->address1 }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="property_address2" id="property_address2" class="form-control" rows="3" placeholder="Address Line 2">{{ $properties->address2 }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="locality" id="locality" value="{{ $properties->locality }}" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="zipcode" id="zipcode" type="text" value="{{ $properties->zipcode }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- Rows -->
