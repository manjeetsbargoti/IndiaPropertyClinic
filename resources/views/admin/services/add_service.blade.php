        ...
        <div class="row">
            <div class="col-xs-12 col-md-9">
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form enctype="multipart/form-data" method="POST" action="{{ url('/admin/add-new-service') }}"
                            id="add_service" name="add_service" novalidate="novalidate">
                            {{ csrf_field() }}
                            <div class="row">
                          ...
                          <label>
                            ...
                            <div class="form-group">
                                <label>
                                    <input type="checkbox" value="1" name="status" id="status" class="minimal-red">
                                    Enable
                                </label>
                            </div>
