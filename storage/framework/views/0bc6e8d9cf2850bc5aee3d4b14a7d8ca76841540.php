                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        ...
                                        <div class="col-xs-6 col-md-6">
                                            <div class="form-group">
                                                <label>
                                                    <input type="checkbox" name="amenity[]" id="<?php echo preg_replace('/[^a-zA-Z0-9-]/','' ,strtolower($a->name)); ?>" class="flat-red" value="<?php echo e($a->amenity_code); ?>"> <?php echo e($a->name); ?>
