<?php /* D:\Laravel\PropertyAdmin\resources\views/admin/repair_services/edit_repair_service.blade.php */ ?>
                    ...
                    <div class="box-body">
                      ...
                      <?php echo e(csrf_field()); ?>
                        ...
                        <div class="form-group">
                            ...
                            <img  style="padding-top: 1em;" src="<?php echo e(asset('/images/backend_images/service_images/large/'.$servicesDetails->service_image)); ?>" style="width:170px;"> <a <?php // href="{{ url('/admin/delete-property-image/'.$propertyDetails->id) }}" ?> >Delete</a>
                            <?php endif; ?>
