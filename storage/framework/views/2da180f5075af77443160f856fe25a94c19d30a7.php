            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="reset_password" id="ResetPassword" method="POST" action="<?php echo e(url('/password/reset')); ?>">
...
<?php echo $__env->make('layouts.frontLayout.frontend_design2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GIT_Code\IndiaPropertyClinic\resources\views/auth/reset_password.blade.php ENDPATH**/ ?>