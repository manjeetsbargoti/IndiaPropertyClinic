                ...
                <div class="box box-purple">
                    ...
                    <div class="box-body">
                        <form enctype="multipart/form-data" method="post"
                            action="<?php echo e(url('/admin/property/'.$properties->id.'/edit')); ?>" name="edit_property"
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="property_name" id="property_name"
                                                    class="form-control" value="<?php echo e($properties->property_name); ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="slug" id="slug" class="form-control"
                                                        value="<?php echo e($properties->property_url); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="property_code" id="property_code" type="text"
                                                        value="<?php echo e($properties->property_code); ?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="property_price" id="property_price" type="text"
                                                    class="form-control" value="<?php echo e($properties->property_price); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="description"
                                                    class="form-control my-editor"><?php echo e($properties->description); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                <label>
                                                    <input type="checkbox" name="feature" id="feature"
                                                        class="flat-green" <?php if($properties->featured=='1'): ?> checked
                                                    <?php endif; ?> value="1"> Featured <small class="text-purple pl-1">( If you
                                            ...
                                            <div class="form-group">
                                                <label>
                                                    <input type="checkbox" name="commercial" id="commercial"
                                                        class="flat-green" <?php if($properties->commercial=='1'): ?> checked
                                                    <?php endif; ?> value="1"> Commercial <small class="text-purple pl-1">( If
                                        ...
                                        <div id="MapPassed" class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="map_passed" id="map_passed" class="form-control">
                                                    <option <?php if($properties->map_pass == ''): ?> selected <?php endif; ?>
                                                        value="">Select</option>
                                                    <option <?php if($properties->map_pass == '1'): ?> selected <?php endif; ?>
                                                        value="1">Yes</option>
                                                    <option <?php if($properties->map_pass == '0'): ?> selected <?php endif; ?>
                                                        value="0">No</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="OpenSides" class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="open_sides" id="open_sides" class="form-control">
                                                    <option value="" <?php if($properties->open_sides == ''): ?> selected
                                                        <?php endif; ?>>Select Open Sides</option>
                                                    <option <?php if($properties->open_sides == '1'): ?> selected <?php endif; ?>
                                                        value="1">1</option>
                                                    <option <?php if($properties->open_sides == '2'): ?> selected <?php endif; ?>
                                                        value="2">2</option>
                                                    <option <?php if($properties->open_sides == '3'): ?> selected <?php endif; ?>
                                                        value="3">3</option>
                                                    <option <?php if($properties->open_sides == '4'): ?> selected <?php endif; ?>
                                                        value="4">4</option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="property_area" id="property_area"
                                                        value="<?php echo e($properties->parea); ?>" type="text"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="width_road_facing" id="width_road_facing" type="text"
                                                        value="<?php echo e($properties->widthroad); ?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="FurnishStatus" class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="furnish_type" id="furnish_type" class="form-control">
                                                    <option value="" <?php if($properties->furnish_type == ''): ?> selected
                                                        <?php endif; ?>>Select Furnish Type</option>
                                                    <option value="F" <?php if($properties->furnish_type == 'F'): ?> selected
                                                        <?php endif; ?>>Fully Furnished</option>
                                                    <option value="S" <?php if($properties->furnish_type == 'S'): ?> selected
                                                        <?php endif; ?>>Semi Furnished</option>
                                                    <option value="U" <?php if($properties->furnish_type == 'U'): ?> selected
                                        ...
                                        <div class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="transection_type" id="transection_type"
                                                    class="form-control">
                                                    <option value="" <?php if($properties->transaction_type == ''): ?> selected
                                                        <?php endif; ?>>Select Transaction Type</option>
                                                    <option value="New Booking" <?php if($properties->transaction_type ==
                                                        'New Booking'): ?> selected <?php endif; ?>>New Booking</option>
                                                    <option value="Resale" <?php if($properties->transaction_type ==
                                                        'Resale'): ?> selected <?php endif; ?>>Resale</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="construction_status" id="construction_status"
                                                    class="form-control">
                                                    <option value="" <?php if($properties->construction_status == ''): ?>
                                                        selected <?php endif; ?>>Select Construction Status</option>
                                                    <option value="UC" <?php if($properties->construction_status == 'UC'): ?>
                                                        selected <?php endif; ?>>Under Construction</option>
                                                    <option value="RM" <?php if($properties->construction_status == 'RM'): ?>
                                                        selected <?php endif; ?>>Ready to Move</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="FloorNo" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="floor_no" id="floor_no" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<165; $i++) { ?>
                                                    <option <?php if($properties->floorno == $i): ?> selected <?php endif; ?>
                                        ...
                                        <div id="TotalFloor" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="total_floors" id="total_floors" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<165; $i++) { ?>
                                                    <option <?php if($properties->total_floors == $i): ?> selected <?php endif; ?>
                                                        value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div id="AppleTrees" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="trees" id="trees" class="form-control">
                                                    ...
                                                    <option <?php if($properties->apple_trees == $i): ?> selected <?php endif; ?>
                                                        value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div id="Bedrooms" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="bedrooms" id="bedrooms" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<250; $i++) { ?>
                                                    <option <?php if($properties->bedrooms == $i): ?> selected <?php endif; ?>
                                                        value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div id="Bathrooms" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="bathrooms" id="bathrooms" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<150; $i++) { ?>
                                                    <option <?php if($properties->bathrooms == $i): ?> selected <?php endif; ?>
                                                        value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div id="Balconies" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="balconies" id="balconies" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<165; $i++) { ?>
                                                    <option <?php if($properties->balconies == $i): ?> selected <?php endif; ?>
                                                        value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div id="PWashroom" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="p_washroom" id="p_washroom" class="form-control">
                                                    <option <?php if($properties->p_washrooms == ''): ?> selected <?php endif; ?> value=""
                                                        selected>Select</option>
                                                    <option <?php if($properties->p_washrooms == '1'): ?> selected <?php endif; ?>
                                                        value="1">Yes</option>
                                                    <option <?php if($properties->p_washrooms == '0'): ?> selected <?php endif; ?>
                                                        value="0">No</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="Cafeteria" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="cafeteria" id="cafeteria" class="form-control">
                                                    <option <?php if($properties->cafeteria == ''): ?> selected <?php endif; ?> value=""
                                                        selected>Select</option>
                                                    <option <?php if($properties->cafeteria == '1'): ?> selected <?php endif; ?>
                                                        value="1">Yes</option>
                                                    <option <?php if($properties->cafeteria == '0'): ?> selected <?php endif; ?>
                                                        value="0">No</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="IsRoadFacing" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="roadfacing" id="roadfacing" class="form-control">
                                                    <option <?php if($properties->road_facing == ''): ?> selected <?php endif; ?> value=""
                                                        selected>Select</option>
                                                    <option <?php if($properties->road_facing == '1'): ?> selected <?php endif; ?>
                                                        value="1">Yes</option>
                                                    <option <?php if($properties->road_facing == '0'): ?> selected <?php endif; ?>
                                                        value="0">No</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="CornerShop" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="corner_shop" id="corner_shop" class="form-control">
                                                    <option <?php if($properties->c_shop == ''): ?> selected <?php endif; ?> value=""
                                                        selected>Select</option>
                                                    <option <?php if($properties->c_shop == '1'): ?> selected <?php endif; ?>
                                                        value="1">Yes</option>
                                                    <option <?php if($properties->c_shop == '0'): ?> selected <?php endif; ?> value="0">No
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="BoundryWall" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="boundrywall" id="boundrywall" class="form-control">
                                                    <option <?php if($properties->wall_made == ''): ?> selected <?php endif; ?> value=""
                                                        selected>Select</option>
                                                    <option <?php if($properties->wall_made == '1'): ?> selected <?php endif; ?>
                                                        value="1">Yes</option>
                                                    <option <?php if($properties->wall_made == '0'): ?> selected <?php endif; ?>
                                                        value="0">No</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="PShowroom" class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="pshowroom" id="pshowroom" class="form-control">
                                                    <option <?php if($properties->p_showroom == ''): ?> selected <?php endif; ?> value=""
                                                        selected>Select</option>
                                                    <option <?php if($properties->p_showroom == '1'): ?> selected <?php endif; ?>
                                                        value="1">Yes</option>
                                                    <option <?php if($properties->p_showroom == '0'): ?> selected <?php endif; ?>
                                                        value="0">No</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="property_age" id="property_age" class="form-control">
                                                    ...
                                                    <?php for($i=1; $i<100; $i++) { ?>
                                                    <option <?php if($properties->property_age == $i): ?> selected <?php endif; ?>
                                                        value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="property_address1" id="property_address1"
                                                    ...
                                                    placeholder="Address Line 1"><?php echo e($properties->address1); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="property_address2" id="property_address2"
                                                    class="form-control" rows="3"
                                                    placeholder="Address Line 2"><?php echo e($properties->address2); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="locality" id="locality"
                                                    value="<?php echo e($properties->locality); ?>" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="zipcode" id="zipcode" type="text"
                                                    value="<?php echo e($properties->zipcode); ?>" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- Rows -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="abcd">
                                            <input type="hidden" name="current_image[]" multiple id="image"
                                                value="<?php echo e($propImages->image_name); ?>">
                                            <img
                                                src="<?php echo e(asset('/images/backend_images/property_images/large/'.$propImages->image_name)); ?>">
                                            <a href="<?php echo e(url('/admin/delete-property-image/'.$propImages->id)); ?>"><i
                                            ...
                                            <div class="form-group">
                                                <label>
                                                    <input type="checkbox" name="amenity[]"
                                                        ...
                                                        class="flat-green" value="<?php echo e($a->amenity_code); ?>"
                                                        <?php $__currentLoopData = explode(',', $properties->amenities); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $am): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($a->amenity_code == $am): ?> checked <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>>
                                                    <?php echo e($a->name); ?>
...
<?php echo $__env->make('layouts.adminLayout.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GIT_Code\IndiaPropertyClinic\resources\views/admin/property/edit_property.blade.php ENDPATH**/ ?>