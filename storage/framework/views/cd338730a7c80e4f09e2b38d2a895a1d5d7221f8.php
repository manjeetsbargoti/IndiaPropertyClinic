		            ...
		            <div class="header_breadcrumb" id="breadcrumb_view">
		                <nav aria-label="breadcrumb">
			                <ol class="breadcrumb">
			                    ...
			                    <li class="breadcrumb-item">Builders in <?php echo e($location); ?></li>
			                </ol>
		                </nav>
		                <p><span><?php echo e($count); ?> Builders </span> </p>
		            </div>
...
<?php echo $__env->make('layouts.frontLayout.frontend_design2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\IndiaPropertyClinic\resources\views/frontend/users/all_builders.blade.php ENDPATH**/ ?>