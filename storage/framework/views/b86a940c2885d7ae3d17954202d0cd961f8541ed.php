<?php /* D:\Laravel\PropertyAdmin\resources\views/frontend/filter_templates/filter_by_state.blade.php */ ?>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-9">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">All Properties in <?php echo e($state->name); ?></li>
                    </ol>
                  </nav>
