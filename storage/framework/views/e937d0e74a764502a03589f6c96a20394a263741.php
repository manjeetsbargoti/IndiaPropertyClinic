            ...
            <div class="col-sm-10 col-md-10 col-lg-10 col-xl-9 mx-auto">
                <div class="card card-signin flex-row my-5">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <h5 class="card-title text-center"><?php echo e(__('Verify Email')); ?></h5>
                        <form name="verify_email_reset_password" id="VerifyEmailResetPassword" method="POST" action="<?php echo e(url('password/verify/email')); ?>">
                            ...
                            <div class="form-label-group">
                                ...
                                <input id="VerifyResetEmailPassword" type="email" class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>"
                                            name="email" value="<?php echo e($email ?? old('email')); ?>" onkeyup="verifyEmailBtnActivation()" required>
                            ...
                            <button class="btn btn-lg btn-primary btn-block text-uppercase" id="VerifyEmilReset" disabled type="submit"><?php echo e(__('Verify Email')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
