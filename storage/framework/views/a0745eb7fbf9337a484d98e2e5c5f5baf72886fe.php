                    ...
                    <form enctype="multipart/form-data" method="POST">
                        ...
                        <div class="box-body">
                                ...
                                <div class="col-xs-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sitemap_links" id="sitemap_links"
                                            value="<?php echo e(config('sitemap_links')); ?>">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="help-block">
                                            <span>Last Created at: <?php echo e(config('sitemap_created_at')); ?></span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="radio-inline">
                                            <label>
                                                <input type="radio" name="sitemap_add_properties" id="" value="1"
                                                    <?php if(config('sitemap_add_properties')): ?> checked <?php endif; ?>> Yes
                                            </label>
                                        </div>
                                        <div class="radio-inline">
                                            <label>
                                                <input type="radio" name="sitemap_add_properties" id="" value="0"
                                                    <?php if(!config('sitemap_add_properties')): ?> checked <?php endif; ?>> No
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="radio-inline">
                                            <label>
                                                <input type="radio" name="sitemap_add_services" id="" value="1"
                                                    <?php if(config('sitemap_add_services')): ?> checked <?php endif; ?>> Yes
                                            </label>
                                        </div>
                                        <div class="radio-inline">
                                            <label>
                                                <input type="radio" name="sitemap_add_services" id="" value="0"
                                                    <?php if(!config('sitemap_add_services')): ?> checked <?php endif; ?>> No
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="radio-inline">
                                            <label>
                                                <input type="radio" name="sitemap_add_categories" id="" value="1"
                                                    <?php if(config('sitemap_add_categories')): ?> checked <?php endif; ?>> Yes
                                            </label>
                                        </div>
                                        <div class="radio-inline">
                                            <label>
                                                <input type="radio" name="sitemap_add_categories" id="" value="0"
                                                    <?php if(!config('sitemap_add_categories')): ?> checked <?php endif; ?>> No
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box-footer">
                                <a href="<?php echo e(url('/admin')); ?>" class="btn btn-default">Cancel</a>
...
<?php echo $__env->make('layouts.adminLayout.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GIT_Code\IndiaPropertyClinic\resources\views/admin/system/seo/sitemap.blade.php ENDPATH**/ ?>