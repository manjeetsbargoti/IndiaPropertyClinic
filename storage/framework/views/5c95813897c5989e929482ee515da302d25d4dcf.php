...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('dist/css/anim_login.css')); ?>">
    <!-- Bootstrap 3.3.7 -->
...
<body>
    ...
    <div class="inputGroup inputGroup1">
        <label for="loginEmail" id="loginEmailLabel" name="email">Email</label>
    ...
    <script src="<?php echo e(asset('dist/js/anim_login.js')); ?>"></script>
...
</html><?php /**PATH D:\GIT_Code\IndiaPropertyClinic\resources\views/admin/admin_login2.blade.php ENDPATH**/ ?>