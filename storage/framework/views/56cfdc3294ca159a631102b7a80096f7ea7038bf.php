...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h3><a href="<?php echo e(url('admin/new-page')); ?>" class="label label-lg label-success">Add New</a></h3>
        <ol class="breadcrumb">
...
<?php echo $__env->make('layouts.adminLayout.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GIT_Code\IndiaPropertyClinic\resources\views/admin/pages/pages_all.blade.php ENDPATH**/ ?>