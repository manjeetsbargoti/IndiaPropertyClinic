<?php /* D:\Laravel\PropertyAdmin\resources\views/admin/repair_services/view_repair_service.blade.php */ ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if($rservice->status==1): ?>
                                            <a href="/admin/disable/<?php echo e($rservice->id); ?>" class="btn btn-success btn-sm">Enable</a>
                                        <?php else: ?>
                                            <a href="/admin/enable/<?php echo e($rservice->id); ?>" class="btn btn-danger btn-sm">Disable</a>
                                        <?php endif; ?>
                                        </td>
                                        <td>
                                            <div id="donate">
