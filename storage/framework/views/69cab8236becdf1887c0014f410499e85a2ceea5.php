<?php /* D:\Laravel\PropertyAdmin\resources\views/frontend/filter_templates/filter_by_city.blade.php */ ?>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-9">
                <div class="header_breadcrumb">
                    <nav aria-label="breadcrumb">
                        ...
                        <li class="breadcrumb-item">All Properties in </li>
                        </ol>
                    </nav>
                        ...
                        <div class="product_box">
                            ...
                            <div class="product_text">
                                ...
                                <div class="protxt_inn">
                                    ...
                                    <p><?php echo str_limit($property->description, $limit=50); ?></p>
                                    <div class="price_sec">
                                        <ul>
