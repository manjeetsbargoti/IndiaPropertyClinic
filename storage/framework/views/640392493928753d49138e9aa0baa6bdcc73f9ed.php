...
<div class="smart_container">
    <div class="property_viewsec">
        <div class="container">
                    ...
                    <div class="outer">
                            ...
                            <div id="big" class="owl-carousel owl-theme">
                                <?php $__currentLoopData = \App\PropertyImages::where('property_id', $property->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pimage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="item">
                                        <img style="max-height: 450px;" src="<?php echo e(asset('/images/backend_images/property_images/large/'.$pimage->image_name)); ?>" alt="<?php echo e($property->property_name); ?>">
                                    </div>
                            ...
                            <div id="thumbs" class="owl-carousel owl-theme">
                                <?php $__currentLoopData = \App\PropertyImages::where('property_id', $property->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pimage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="item">
                                        <img style="max-height: 100px;" src="<?php echo e(asset('/images/backend_images/property_images/large/'.$pimage->image_name)); ?>">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
            ...
            <div class="col-12 col-xl-4">
                <div class="overview_property">
                    <h1><i class="fas fa-map-marker-alt"></i> <a href="<?php echo e(url('/city/'.$property->city_name.'/properties')); ?>"><?php if(!empty($property->city_name)): ?> <?php echo e($property->city_name); ?>,<?php endif; ?> <?php if(!empty($property->country_name)): ?> <?php echo e($property->country_name); ?> <?php endif; ?></a></h1>
                    ...
                    <p style="font-size: 14px; color: #171747; font-weight: 500;"><?php echo str_limit(strip_tags($property->description), $limit=350); ?></p>
        ...
        <div class="col-12 col-sm-12 col-md-12 mt-3 text-center">
            <?php echo $__env->make('admin.google_ads.partials.large_leaderboard_970_90', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    </div>
            ...
            <div class="col-12 col-md-12 col-xl-12">
                ...
                <div class="row">
                    ...
                    <?php if($counter <= 8): ?> <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                        <a href="<?php echo e(url('/properties/'.$relproperty->property_url)); ?>"><div class="product_box">
                            <div class="product_img">
                                <div class="owl-carousel product-slide owl-theme">
                                    ...
                                    <div class="item"><img class="img-fluid" style="max-height: 161px;" src="<?php echo e(asset('/images/backend_images/property_images/large/'.$pimage->image_name)); ?>" alt="<?php echo e($relproperty->property_name); ?>">
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
...
<?php echo $__env->make('layouts.frontLayout.frontend_design2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\IndiaPropertyClinic\resources\views/frontend/view_single_property.blade.php ENDPATH**/ ?>