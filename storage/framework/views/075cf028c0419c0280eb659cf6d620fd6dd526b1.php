                        ...
                        <div class="filter">
                            ...
                            <div class="filter_box">
                                <ul>
                                    ...
                                    <li>
                                        <h6>BUDGET<a href="#">Clear</a></h6>
                                    </li>
                                    <li>
                                        <form>
                                            <div class="range_mintomax">
                                                <input type="range" name="ageInputName" id="ageInputId" value="200000"
                                                    min="1" max="10000000"
                                                    oninput="ageOutputId.value = ageInputId.value">
                                                <span>₹ </span><output class="text" name="ageOutputName"
                                                    id="ageOutputId">200000</output>
                                            </div>
                                        </form>
                                    </li>
                                </ul>
                                        ...
                                        <div class="price_sec">
                                            <ul>
                                                <li>
                                                    ...
                                                    <h5><span><?php echo e($property->currency); ?></span>
                                                ...
                                                <li><a href="/properties/<?php echo e($property->property_url); ?>"
