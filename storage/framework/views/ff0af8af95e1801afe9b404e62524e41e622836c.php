                            ...
                            <div class="row justify-content-md-center">
                                <div class="form-group col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <select name="offered_service" id="OfferedBService" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $repair_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rservice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
