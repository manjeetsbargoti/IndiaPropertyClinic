                            ...
                            <div class="col-xs-12 col-md-4">
                              <div class="form-group">
                                  ...
                                  <select name="country" id="country" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                      ...
                                      <option value="<?php echo e($country->iso2); ?>"><?php echo e($country->name); ?> [<?php echo e($country->iso2); ?>]</option>
...
<?php echo $__env->make('layouts.adminLayout.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GIT_Code\IndiaPropertyClinic\resources\views/admin/csc_temp/add_city.blade.php ENDPATH**/ ?>