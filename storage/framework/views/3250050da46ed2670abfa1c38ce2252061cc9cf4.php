        ...
        <div class="row">
            <div class="col-xs-12 col-md-12">
                <div class="box box-info">
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form enctype="multipart/form-data" method="POST" action="<?php echo e(url('/admin/ppc/page/new')); ?>"
                            ...
                            <div class="col-sm-4 col-md-4">
                                ...
                                <div class="form-group" id="MainServices">
                                    ...
                                    <select name="main_service" id="MainServiceList" class="form-control">
                                        ...
                                        <option value="<?php echo e($hs->id); ?>"><?php echo e($hs->service_name); ?></option>
...
<?php echo $__env->make('layouts.adminLayout.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GIT_Code\IndiaPropertyClinic\resources\views/admin/ppc_pages/new_ppc_page.blade.php ENDPATH**/ ?>