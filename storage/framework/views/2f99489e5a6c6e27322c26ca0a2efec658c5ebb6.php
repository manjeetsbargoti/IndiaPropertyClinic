        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-3">
                <div class="left_sidebar">
                    ...
                    <?php echo $__env->make('admin.google_ads.partials.square_250_250', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make('admin.google_ads.partials.wide_skyscraper_160_600', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-9">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">All Properties in <?php echo e($scityname); ?></li>
                    </ol>
                  </nav>
                ...
                <?php } ?>
                  <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                        <a href="/properties/<?php echo e($property->property_url); ?>"><div class="product_box">
                            <div class="product_img">
                                <div class="owl-carousel product-slide owl-theme">
                                    <?php $__currentLoopData = \App\PropertyImages::where('property_id', $property->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pimage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="item">
                                            <img class="img-fluid" style="max-height: 161px;" src="<?php echo e(asset('/images/backend_images/property_images/large/'.$pimage->image_name)); ?>">
                                        </div>
...
<?php echo $__env->make('layouts.frontLayout.frontend_design2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GITHUB\IndiaPropertyClinic\resources\views/frontend/filter_templates/search_result.blade.php ENDPATH**/ ?>