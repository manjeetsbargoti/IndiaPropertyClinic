          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <?php if(Auth::user()->admin  == 1 || Auth::user()->usertype  == 'S'): ?>
              <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                      <li><a href="<?php echo e(url('/admin/pages')); ?>"><i class="fa fa-file text-green"></i> <span>Pages</span></a></li>
                      <li><a href="<?php echo e(url('/admin/new-page')); ?>"><i class="fa fa-plus text-green"></i> <span>Add
                                  Page</span></a></li>
                  </ul>
              </li>
            <?php endif; ?>
              ...
              <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                      ...
                      <li><a href="<?php echo e(url('/admin/home-loan-application')); ?>"><i
                        ...
                        <li><a href="<?php echo e(url('/admin/phone-queries')); ?>"><i
